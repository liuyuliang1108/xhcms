...
<!--content start-->
<div class="content">
<div class="title"><h3><?php echo $info['title']; ?> </h3></div>
<div class="infos"><?php echo date("Y-m-d H:i:s",$info['create_time']); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;点击：<script language="javascript" src="<?php echo url('index/view/hits',['content_id'=>$info['content_id']]); ?>"></script></div>
<div class="maincontent clearfix">

<div class="maincontent clearfix">

拓展字段缩略图：<img src="<?php echo $info['thumb']; ?>"><br>
<br/>
拓展字段描述：<?php echo $info['des']; ?><br/><br/>
拓展字段编辑器1：<?php echo $info['xheditor']; ?><br/><br/>
拓展字段编辑器2：<?php echo $info['ueditor']; ?>
...
<div class="prenext">
<ul><li>上一篇：<?php echo $shownext[0]; ?></li><li>下一篇：<?php echo $shownext[1]; ?></li></ul>
</div>
