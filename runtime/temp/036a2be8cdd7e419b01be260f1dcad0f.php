<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\phpStudy\WWW\xhcms\home/../application/admin\view\member\batchUpdate.html";i:1556813246;s:67:"D:\phpStudy\WWW\xhcms\application\admin\view\common\_container.html";i:1556813246;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<input type="hidden" name='m_id' id='m_id' value="<?php echo $info['m_id']; ?>" />
		...
		<div class="form-horizontal" id="CodeInfoForm">
			<div class="row">
				...
				<!-- form start -->
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" id="headimgurl" value="<?php echo $info['headimgurl']; ?>" name="headimgurl" <?php echo hook('view_big_pic',['type'=>2]); ?> class="form-control" placeholder="请输入头像">
						</div>
						<div class="col-sm-2" style="position:relative; right:30px;">
							<span id="headimgurl_upload"></span>
						</div>
					</div>
				<!-- form end -->
				</div>
			...
			<div class="row btn-group-m-t">
				<div class="col-sm-9 col-sm-offset-1">
					<button type="button" class="btn btn-primary" onclick="CodeInfoDlg.batchUpdate()" id="ensure">
...
<script src="__PUBLIC__/static/js/admin/Member.js?t=<?php echo rand(1000,9999)?>" charset="utf-8"></script>
...
uploader('headimgurl_upload','headimgurl','image',false,'','<?php echo url("admin/Upload/uploadImages"); ?>');
</script>
