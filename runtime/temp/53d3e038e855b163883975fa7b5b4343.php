<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\phpStudy\WWW\xhcms\home/../application/admin\view\do_html\viewprocess.html";i:1556813246;s:67:"D:\phpStudy\WWW\xhcms\application\admin\view\common\_container.html";i:1556813246;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
	...
	function send(){
		...
		ajax.set('page',p++);
		ajax.set('classId','<?php echo $classId; ?>');
		ajax.set('pagesize','<?php echo $pagesize; ?>');
		ajax.set('startId','<?php echo $startId; ?>');
		ajax.set('endId','<?php echo $endId; ?>');
		ajax.start();
	}
