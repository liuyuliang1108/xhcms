<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\phpStudy\WWW\xhcms\home/../application/admin\view\linkcatagory\index.html";i:1556813246;s:67:"D:\phpStudy\WWW\xhcms\application\admin\view\common\_container.html";i:1556813246;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
				...
				<div class="row row-lg">
					<div class="col-sm-12">
							...
							<div class="col-sm-2">
								<div class="input-group">
									<div class="input-group-btn">
										<button data-toggle="dropdown" class="btn btn-white dropdown-toggle" type="button">分类名称</button>
									</div>
						...
						<div id="CodeGoodsTableToolbar" role="group">
							<?php if(in_array('/admin/Linkcatagory/add',session('admin.nodes')) || session('admin.role') == 1): ?>
							<button type="button" id="add" class="btn btn-primary button-margin" onclick="CodeGoods.add()">
								<i class="fa fa-plus"></i>&nbsp;添加
							</button>
							<?php endif; if(in_array('/admin/Linkcatagory/update',session('admin.nodes')) || session('admin.role') == 1): ?>
							<button type="button" id="update" class="btn btn-primary button-margin" onclick="CodeGoods.update()">
								<i class="fa fa-edit"></i>&nbsp;修改
							</button>
							<?php endif; if(in_array('/admin/Linkcatagory/delete',session('admin.nodes')) || session('admin.role') == 1): ?>
...
<script>
	...
	CodeGoods.initColumn = function () {
 		return [
 			...
 			{title: '编号', field: 'catagory_id', visible: true, align: 'center', valign: 'middle'},
 			{title: '分类名称', field: 'title', visible: true, align: 'center', valign: 'middle'},
 			{title: '排序', field: 'sortid', visible: true, align: 'center', valign: 'middle'},
 			{title: '操作', field: 'catagory_id', visible: true, align: 'center', valign: 'middle',formatter: 'CodeGoods.buttonFormatter'},
 		];
 	};
	...
	CodeGoods.add = function (value) {
		...
		var index = layer.open({type: 2,title: '创建数据',area: ['600px', '350px'],fix: false, maxmin: true,content: Feng.ctxPath + '/Linkcatagory/add'+url});
	...
	CodeGoods.update = function (value) {
		if(value){
			var index = layer.open({type: 2,title: '编辑数据',area: ['600px', '350px'],fix: false, maxmin: true,content: Feng.ctxPath + '/Linkcatagory/update/catagory_id/'+value});
		}else{
			if (this.check()) {
				var idx = '';

				$.each(CodeGoods.seItem, function() {
					idx += ',' + this.catagory_id;
				});
				...
				var index = layer.open({type: 2,title: '编辑数据',area: ['600px', '300px'],fix: false, maxmin: true,content: Feng.ctxPath + '/Linkcatagory/update/catagory_id/'+idx});
				this.layerIndex = index;
			}
		}
	}
	...
	CodeGoods.delete = function (value) {
		if(value){
			Feng.confirm("是否删除选中项？", function () {
				var ajax = new $ax(Feng.ctxPath + "/Linkcatagory/delete", function (data) {
					if ('00' === data.status) {
	...
	$(function() {
		...
		var url = location.search;
		var table = new BSTable(CodeGoods.id, Feng.ctxPath+"/Linkcatagory/index"+url,defaultColunms,20);
